...
In part-2, I'll be implementing fully decentralized blockchain network by exposing few APIs written in [Flask](http://flask.pocoo.org/). That will cover remaining concepts like **Node**, **Consensus,** etc**.**
